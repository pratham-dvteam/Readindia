		...
		<!-- <form id = "id_summarysheet" name="summarysheet" method = "post" >-->
			...
			<center> 
				<table bgcolor="#F0F0F0" border="1" cellpadding="3" cellspacing="0">
					...
					<tr>
						<td><center><input  class = "optionBox" id="id_submission1" value = "1"  name="id_submission1" type="checkbox"  value="1" /> </center></td>
						<td id = "checkbox2"><div id ="id_div1"><center><input class = "optionBox"  id="id_submission2" name="" value = "2" type="checkbox" value="2" /> </center></td>
						<td><center><input class = "optionBox"  id="id_submission3" name="" value = "3" type="checkbox" value="3" /> </center></td>
						<td><center><input  class = "optionBox" id="id_submission4" name="" value = "4" type="checkbox" value="4" /> </center></td>
						<td><center><input  class = "optionBox" id="id_submitted" name="" value = "" type="checkbox" value="5" /> </center></td>
					</tr>
				</table>     
			</center> 
			...
			<table bgcolor="#F0F0F0" align="center" id ="id_table1" border="2px" bordercolor="#538467" cellpadding="2" cellspacing="0" id="" style="border-collapse:collapse;" width="98%">
			   ...
			   <tr align="center">     
					...
					<!--Camp 4 Attendance -->
					<td id="">71% - 100%</td>  				
					<td colspan="3"><input class="submission_4" id="id_totalchildren_71to100" name="attendance71to100" size="10" style="width:30px;" type="text"></td>
				</tr>
			</table>		
				<br> <br>		
		...
		$(document).ready(function() {
	        ...
	        $('.save').click(function(e) {
				...
				if (submissionno_entered == 1 && ($("#id_submission2").prop('checked') == false)){
					...
					$("#checkbox2").css("background-color", "#D15D52");
					return;
				}; 
				...
				if (mismatch_children != 0) {
					...
					alert('Number of targeted and Calss wise entered children are not matching')
					return;
				};

				//Making sure target children and sum of male and female children number are equal.
				...
				if (mismatch_children != 0) {
					alert('Number of targete and male/female children are not matching')
					$("#id_childrenMale").focus();
					return;
				};
