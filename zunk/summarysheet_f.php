				...
				<tr align="center">
					...
					<td colspan="2" style="">
						<label style="font-family:calibri;font-size:17px;font-weight:bold;">
							<input class="submission_1" id="id_schoolcode" maxlength="11" name="schoolCode" size="20" style="width:98px;" type="text" value="<?php echo $schoolCode; ?>"></label></td>
				 ...
				 <tbody>
				   ...
				   <tr align="center">
					...
					<tr align="center">
					   ...
					   <td id="ft1" width="13%"><label style="width:20px;">0</label></td>
					   <td id="ft1" width="13%"><label style="width:20px;">0</label></td>
					   <td id="ft1" width="12%"><label style="width:20px;">0</label></td>
					   <td id="ft1" width="11%"><label style="width:20px;">0</label></td>
					   <td id="ft1" width="9%"><label style="width:20px;">0</label></td>
					   <td id="ft1" width="10%"><label style="width:20px;">0</label></td>
					</tr>
