...
<?php
			...
			$sql3= mysql_query("INSERT into table3 (schoolcode, volunteer1Type , 	volunteer1Education , 	volunteer1AttendanceCamp1 , 	volunteer1AttendanceCamp2 , 	volunteer1AttendanceCamp3 , 	volunteer1AttendanceCamp4 , 	volunteer2Type , 	volunteer2Education , 	volunteer2AttendanceCamp1 , 	volunteer2AttendanceCamp2 , 	volunteer2AttendanceCamp3 , 	volunteer2AttendanceCamp4 , 	volunteer3Type , 	volunteer3Education , 	volunteer3AttendanceCamp1 , 	volunteer3AttendanceCamp2 , 	volunteer3AttendanceCamp3 , 	volunteer3AttendanceCamp4 , 	volunteer4Type , 	volunteer4Education , 	volunteer4AttendanceCamp1 , 	volunteer4AttendanceCamp2 , 	volunteer4AttendanceCamp3 , 	volunteer4AttendanceCamp4 , 	volunteer5Type , 	volunteer5Education , 	volunteer5AttendanceCamp1 , 	volunteer5AttendanceCamp2 , 	volunteer5AttendanceCamp3 , 	volunteer5AttendanceCamp4 , 	volunteer6Type , 	volunteer6Education , 	volunteer6AttendanceCamp1 , 	volunteer6AttendanceCamp2 , 	volunteer6AttendanceCamp3 , 	volunteer6AttendanceCamp4 , 	volunteer7Type , 	volunteer7Education , 	volunteer7AttendanceCamp1 , 	volunteer7AttendanceCamp2 , 	volunteer7AttendanceCamp3 , 	volunteer7AttendanceCamp4 , 	volunteer8Type , 	volunteer8Education , 	volunteer8AttendanceCamp1 , 	volunteer8AttendanceCamp2 , 	volunteer8AttendanceCamp3 , 	volunteer8AttendanceCamp4 , 	volunteer9Type , 	volunteer9Education , 	volunteer9AttendanceCamp1 , 	volunteer9AttendanceCamp2 , 	volunteer9AttendanceCamp3 , 	volunteer9AttendanceCamp4 , 	volunteer10Type , 	volunteer10Education , 	volunteer10AttendanceCamp1 , 	volunteer10AttendanceCamp2 , 	volunteer10AttendanceCamp3 , 	volunteer10AttendanceCamp4) 
                  values ('$schoolCode','$volunteer1Type' , 	'$volunteer1Education' , 	'$volunteer1AttendanceCamp1' , 	'$volunteer1AttendanceCamp2' , 	'$volunteer1AttendanceCamp3' , 	'$volunteer1AttendanceCamp4' , 	'$volunteer2Type' , 	'$volunteer2Education' , 	'$volunteer2AttendanceCamp1' , 	'$volunteer2AttendanceCamp2' , 	'$volunteer2AttendanceCamp3' , 	'$volunteer2AttendanceCamp4' , 	'$volunteer3Type' , 	'$volunteer3Education' , 	'$volunteer3AttendanceCamp1' , 	'$volunteer3AttendanceCamp2' , 	'$volunteer3AttendanceCamp3' , 	'$volunteer3AttendanceCamp4' , 	'$volunteer4Type' , 	'$volunteer4Education' , 	'$volunteer4AttendanceCamp1' , 	'$volunteer4AttendanceCamp2' , 	'$volunteer4AttendanceCamp3' , 	'$volunteer4AttendanceCamp4' , 	'$volunteer5Type' , 	'$volunteer5Education' , 	'$volunteer5AttendanceCamp1' , 	'$volunteer5AttendanceCamp2' , 	'$volunteer5AttendanceCamp3' , 	'$volunteer5AttendanceCamp4' , 	'$volunteer6Type' , 	'$volunteer6Education' , 	'$volunteer6AttendanceCamp1' , 	'$volunteer6AttendanceCamp2' , 	'$volunteer6AttendanceCamp3' , 	'$volunteer6AttendanceCamp4' , 	'$volunteer7Type' , 	'$volunteer7Education' , 	'$volunteer7AttendanceCamp1' , 	'$volunteer7AttendanceCamp2' , 	'$volunteer7AttendanceCamp3' , 	'$volunteer7AttendanceCamp4' , 	'$volunteer8Type' , 	'$volunteer8Education' , 	'$volunteer8AttendanceCamp1' , 	'$volunteer8AttendanceCamp2' , 	'$volunteer8AttendanceCamp3' , 	'$volunteer8AttendanceCamp4' , 	'$volunteer9Type' , 	'$volunteer9Education' , 	'$volunteer9AttendanceCamp1' , 	'$volunteer9AttendanceCamp2' , 	'$volunteer9AttendanceCamp3' , 	'$volunteer9AttendanceCamp4' , 	'$volunteer10Type' , 	'$volunteer10Education' , 	'$volunteer10AttendanceCamp1' , 	'$volunteer10AttendanceCamp2' , 	'$volunteer10AttendanceCamp3' , 	'$volunteer10AttendanceCamp4')");
			...
			//Table 6
	            ...
	            $tbl6Data = $_REQUEST['tbl6Info'];
				 ...
				 @$progressAcrossReadingTotalBG= $tbl6Data['total'][0]['ReadingBGBG'];
				 @$progressAcrossReadingTotalLT= $tbl6Data['total'][0]['ReadingBGLT'];
				 @$progressAcrossReadingTotalWD= $tbl6Data['total'][0]['ReadingBGWD'];
				 @$progressAcrossReadingTotalPR= $tbl6Data['total'][0]['ReadingBGPR'];
				 @$progressAcrossReadingTotalSY= $tbl6Data['total'][0]['ReadingBGSY'];
				 @$progressAcrossReadingTotalTotal= $tbl6Data['total'][0]['ReadingBGTotal'];

			$sql6= mysql_query ("INSERT INTO table6 (schoolcode, progressAcrossReadingBGBG , 	progressAcrossReadingBGLT , 	progressAcrossReadingBGWD , 	progressAcrossReadingBGPR , 	progressAcrossReadingBGSY , 	progressAcrossReadingBGTotal , 	progressAcrossReadingLTBG , 	progressAcrossReadingLTLT , 	progressAcrossReadingLTWD , 	progressAcrossReadingLTPR , 	progressAcrossReadingLTSY , 	progressAcrossReadingLTTotal , 	progressAcrossReadingWDBG , 	progressAcrossReadingWDLT , 	progressAcrossReadingWDWD , 	progressAcrossReadingWDPR , 	progressAcrossReadingWDSY , 	progressAcrossReadingWDTotal , 	progressAcrossReadingPRBG , 	progressAcrossReadingPRWD , 	progressAcrossReadingPRLT , 	progressAcrossReadingPRPR , 	progressAcrossReadingPRSY , 	progressAcrossReadingPRTotal , 	progressAcrossReadingSYBG , 	proogressAcrossReadingSYLT , 	proogressAcrossReadingSYWD , 	progressAcrossReadingSYPR , 	progressAcrossReadingSYSY , 	progressAcrossReadingSYTotal ) 
				VALUES ('$schoolCode', '$progressAcrossReadingBGBG' , 	'$progressAcrossReadingBGLT' , 	'$progressAcrossReadingBGWD' , 	'$progressAcrossReadingBGPR' , 	'$progressAcrossReadingBGSY' , 	'$progressAcrossReadingBGTotal' , 	'$progressAcrossReadingLTBG' , 	'$progressAcrossReadingLTLT' , 	'$progressAcrossReadingLTWD' , 	'$progressAcrossReadingLTPR' , 	'$progressAcrossReadingLTSY' , 	'$progressAcrossReadingLTTotal' , 	'$progressAcrossReadingWDBG' , 	'$progressAcrossReadingWDLT' , 	'$progressAcrossReadingWDWD' , 	'$progressAcrossReadingWDPR' , 	'$progressAcrossReadingWDSY' , 	'$progressAcrossReadingWDTotal' , 	'$progressAcrossReadingPRBG' , 	'$progressAcrossReadingPRWD' , 	'$progressAcrossReadingPRLT' , 	'$progressAcrossReadingPRPR' , 	'$progressAcrossReadingPRSY' , 	'$progressAcrossReadingPRTotal' , 	'$progressAcrossReadingSYBG' , 	'$proogressAcrossReadingSYLT' , 	'$proogressAcrossReadingSYWD' , 	'$progressAcrossReadingSYPR' , 	'$progressAcrossReadingSYSY' , 	'$progressAcrossReadingSYTotal')");
			...
			$sql7= mysql_query ("INSERT INTO table7 (schoolCode, std1_2BLChildren , 	std1_2BLReadingBG , 	std1_2BLReadingLT , 	std1_2BLReadingWD , 	std1_2BLReadingPR , 	std1_2BLReadingSY , 	std1_2BLNumberBG , 	std1_2BLNumber1Digit , 	std1_2BLNumber2Digits , 	std1_2BLOperationAC , 	std1_2BLOperationACN , 	std1_2BLOperationSC , 	std1_2BLOperationSCN , 	std1_2ELChildren , 	std1_2ELReadingBG , 	std1_2ELReadingLT , 	std1_2ELReadingWD , 	std1_2ELReadingPR , 	std1_2ELReadingSY , 	std1_2ELNumberBG , 	std1_2ELNumber1Digit , 	std1_2ELNumber2Digits , 	std1_2ELOperationAC , 	std1_2ELOperationACN , 	std1_2ELOperationSC , 	std1_2ELOperationSCN) 
				VALUES ('$schoolCode','$std1_2BLChildren' , 	'$std1_2BLReadingBG' , 	'$std1_2BLReadingLT' , 	'$std1_2BLReadingWD' , 	'$std1_2BLReadingPR' , 	'$std1_2BLReadingSY' , 	'$std1_2BLNumberBG' , 	'$std1_2BLNumber1Digit' , 	'$std1_2BLNumber2Digits' , 	'$std1_2BLOperationAC' , 	'$std1_2BLOperationACN' , 	'$std1_2BLOperationSC' , 	'$std1_2BLOperationSCN' , 	'$std1_2ELChildren' , 	'$std1_2ELReadingBG' , 	'$std1_2ELReadingLT' , 	'$std1_2ELReadingWD' , 	'$std1_2ELReadingPR' , 	'$std1_2ELReadingSY' , 	'$std1_2ELNumberBG' , 	'$std1_2ELNumber1Digit' , 	'$std1_2ELNumber2Digits' , 	'$std1_2ELOperationAC' , 	'$std1_2ELOperationACN' , 	'$std1_2ELOperationSC' , 	'$std1_2ELOperationSCN' )");
