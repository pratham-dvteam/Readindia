			   ...
			   <tr align="center">     
				...
				<table border="1px" bordercolor="#538467" cellpadding="2" cellspacing="0" style="border-collapse:collapse;" width="100%">   
					...
					<tr align="center">
					  ...
					  <td width="4%"><input class="submission_1" id="id_additional_before_endline2_number_0-9" name="additionalChildBeforeEL2Number1Digit" size="10" style="width:20px;" type="text"></td>
					  
					  <!--  Table 4 - for ADDITIONAL CHILDREN BEFORE ENDLINE 2 - Number - 10to99 -->
					  <td width="5%"><input class="submission_1" id="id_additional_before_endline2_number_10-99" name="additionalChildBeforeEL2Number2Digits" size="10" style="width:20px;" type="text"></td>					
					  
					  <!--  Table 4 - for ADDITIONAL CHILDREN BEFORE ENDLINE 2 - Number - 100to999 -->
					  <td width="5%"><input class="submission_1" id="id_additional_before_endline2_number_100-999" name="additionalChildBeforeEL2Number3Digits" size="10" style="width:20px;" type="text"></td>					
					...
					<tr align="center">
					  ...
					  <td width="4%"><input class="submission_1" id="id_additional_before_endline3_number_0-9" name="additionalChildBeforeEL3Number1Digit" size="10" style="width:20px;" type="text"></td>
					  
					  <!--  Table 4 - for ADDITIONAL CHILDREN BEFORE ENDLINE 3 - Number - 10to99 -->
					  <td width="5%"><input class="submission_1" id="id_additional_before_endline3_number_10-99" name="additionalChildBeforeEL3Number2Digits" size="10" style="width:20px;" type="text"></td>
					  
					  <!--  Table 4 - for ADDITIONAL CHILDREN BEFORE ENDLINE 3 - Number - 100to999 -->
					  <td width="5%"><input class="submission_1" id="id_additional_before_endline3_number_100-999" name="additionalChildBeforeEL3Number3Digits" size="10" style="width:20px;" type="text"></td>
					  <td id="ft" width="22%">Update from Universal Child Sheet for each class and add all three classes</td>
					</tr>
				   ...
				   <tr align="center">
					   ...
					   <!--  Table 4 - for ADDITIONAL CHILDREN BEFORE ENDLINE 3 - Number - 0to9 -->
					   <td width="4%"><input class="submission_1" id="id_additional_before_endline4_number_0-9" name="additionalChildBeforeEL4Number1Digit" size="10" style="width:20px;" type="text"></td>
					   
					   <!--  Table 4 - for ADDITIONAL CHILDREN BEFORE ENDLINE 3 - Number - 10to99 -->
					   <td width="5%"><input class="submission_1" id="id_additional_before_endline4_number_10-99" name="additionalChildBeforeEL4Number2Digits" size="10" style="width:20px;" type="text"></td>
					   
					   <!--  Table 4 - for ADDITIONAL CHILDREN BEFORE ENDLINE 3 - Number - 100to999 -->
					   <td width="5%"><input class="submission_1" id="id_additional_before_endline4_number_100-999" name="additionalChildBeforeEL4Number3Digits" size="10" style="width:20px;" type="text"></td>
	...
	<script type="text/javascript"> 
		...
		function getRequestData(){
	        ...
	        requestData['tbl4Info']['std3'].push({
				...
				'Number1Digit':$('#id_std3_number_0-9').val(),
				'Number2Digits':$('#id_std3_number_10-99').val(),
				'Number3Digits':$('#id_std3_number_100-999').val(),
	       ...
	       //std 4
	        ...
	        requestData['tbl4Info']['std4'].push({				
				...
				'Number1Digit':$('#id_std4_number_0-9').val(),
				'Number2Digits':$('#id_std4_number_10-99').val(),
				'Number3Digits':$('#id_std4_number_100-999').val(),
	        });
	       ...
	       //std 5
	        ...
	        requestData['tbl4Info']['std5'].push({								
				...
				'Number1Digit':$('#id_std5_number_0-9').val(),
				'Number2Digits':$('#id_std5_number_10-99').val(),
				'Number3Digits':$('#id_std5_number_100-999').val(),
	        });
	       ...
	       //std AdditionalChildrenbeforeEL2
	        ...
	        requestData['tbl4Info']['beforeEL2'].push({								
				...
				'Number1Digit':$('#id_additional_before_endline2_number_0-9').val(),
				'Number2Digits':$('#id_additional_before_endline2_number_10-99').val(),
				'Number3Digits':$('#id_additional_before_endline2_number_100-999').val(),
	       ...
	       //std AdditionalChildrenbeforeEL3
	        ...
	        requestData['tbl4Info']['beforEL3'].push({								
				...
				'Number1Digit':$('#id_additional_before_endline3_number_0-9').val(),
				'Number2Digits':$('#id_additional_before_endline3_number_10-99').val(),
				'Number3Digits':$('#id_additional_before_endline3_number_100-999').val(),
	        });
	       ...
	       //std AdditionalChildrenbeforeEL4
	        ...
	        requestData['tbl4Info']['beforEL4'].push({												
				...
				'Number1Digit':$('#id_additional_before_endline4_number_0-9').val(),
				'Number2Digits':$('#id_additional_before_endline4_number_10-99').val(),
				'Number3Digits':$('#id_additional_before_endline4_number_100-999').val(),
	        });
	       ...
	       //ConsolidatedBL
		    ...
		    requestData['tbl5Info']['baseline'].push({
				...
				'Number1Digit':$('#id_totaltested_number_0-9').val(),
				'Number2Digits':$('#id_totaltested_number_10-99').val(),
				'Number3Digits':$('#id_totaltested_number_100-999').val(),
			});
	        ...
	        requestData['tbl5Info']['LC1'].push({								
				...
				'Number1Digit':$('#id_lc1_endline_number_0-9').val(),
				'Number2Digits':$('#id_lc1_endline_number_10-99').val(),
				'Number3Digits':$('#id_lc1_endline_number_100-999').val(),
	        ...
	        requestData['tbl5Info']['LC2'].push({					
				...
				'Number1Digit':$('#id_lc2_endline_number_0-9').val(),
				'Number2Digits':$('#id_lc2_endline_number_10-99').val(),
				'Number3Digits':$('#id_lc2_endline_number_100-999').val(),
	        ...
	        requestData['tbl5Info']['LC3'].push({					
				...
				'Number1Digit':$('#id_lc3_endline_number_0-9').val(),
				'Number2Digits':$('#id_lc3_endline_number_10-99').val(),
				'Number3Digits':$('#id_lc3_endline_number_100-999').val(),
	        ...
	        requestData['tbl5Info']['LC4'].push({					
				...
				'Number1Digit':$('#id_lc4_endline_number_0-9').val(),
				'Number2Digits':$('#id_lc4_endline_number_10-99').val(),
				'Number3Digits':$('#id_lc4_endline_number_100-999').val(),
	        ...
	        requestData['tbl5Info']['ConsolidatedEL'].push({					
				...
				'Number1Digit':$('#id_cons_endline_number_0-9').val(),
				'Number2Digits':$('#id_cons_endline_number_10-99').val(),
				'Number3Digits':$('#id_cons_endline_number_100-999').val(),
