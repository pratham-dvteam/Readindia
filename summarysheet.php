			...
			<table bgcolor="#F0F0F0" align="center" id ="id_table1" border="2px" bordercolor="#538467" cellpadding="2" cellspacing="0" id="" style="border-collapse:collapse;" width="98%">
				...
				<tr align="center">
					...
					<td class="c_submission1" rowspan="2">
						...
						<option value="1">3 Camp</option>
						<option value="2">4 Camp</option>
					</td>
		...
		$(document).ready(function() {
		        ...
		        success: function(table2_response){                    
					...
					//var entered_submissionno = 0;
		  		   ...
		  		   window.entered_submissionno = (table2_response[0][1]);
	...
	<script type="text/javascript"> 
		$(document).ready(function() {
	        ...
	        $('.save').click(function(e) {
	        	...
	        	//Getting camp no which going to be entered.
				var submitting_camp = $('input[type=checkbox]:checked').not(':enabled').length;

				//Validation for Camp 1 Entry.
					if (submitting_camp == 0 ){
						var err = 1										
				...
				// Validation for Camp 2 Entry.
					...
					//Validation 4 - Number of teaching days Range 0 to 10.
				  		if ($("#id_teachingdays_camp2").val() > 11 ) {
						...
						//Validation 6 - Number of Visits Range - 0 to 10 Table 2.
					  		if ($("#id_noofvisits_camp2").val() > 11 ) {
								$("#id_noofvisits_camp2").attr('title', 'DISE code should not be more or less than 10 digits.');		  						
		  						$("#id_noofvisits_camp2").css('border-color', 'red'); 					
		  					};		
						//Validation 7 - Volunteer Attendance in Table 3.

					  		if ($("#id_volunteer1_attendance_camp2").val() > 11 ) {
					  		...
					  		if ($("#id_volunteer2_attendance_camp2").val() > 11 ) {
						...
						//Table 4 - tested children (Lang) should be equal to no of tested children.	
							var table4_tested  = +$("#id_additional_before_endline2_tested").val();
							
							var table4_lan_b = +$("#id_additional_before_endline2_reading_beg").val();
							var table4_lan_l = +$("#id_additional_before_endline2_reading_letter").val();
							var table4_lan_w = +$("#id_additional_before_endline2_reading_word").val();
							var table4_lan_p = +$("#id_additional_before_endline2_reading_para").val();
							var table4_lan_s = +$("#id_additional_before_endline2_reading_story").val();

							var table4_lan_tot = table4_lan_b + table4_lan_l + table4_lan_w + table4_lan_p + table4_lan_s;

							var mismatched = table4_tested - table4_lan_tot;
														

							if (mismatched != 0) {
								$("#id_additional_before_endline2_tested").attr('title', 'Number of children entered for calss and gender is not matching.');
								$("#id_additional_before_endline2_reading_beg").attr('title', 'Number of children entered for calss and gender is not matching.');
								$("#id_additional_before_endline2_reading_letter").attr('title', 'Number of children entered for calss and gender is not matching.');
								$("#id_additional_before_endline2_reading_word").attr('title', 'Number of children entered for calss and gender is not matching.');
								$("#id_additional_before_endline2_reading_para").attr('title', 'Number of children entered for calss and gender is not matching.');
								$("#id_additional_before_endline2_reading_story").attr('title', 'Number of children entered for calss and gender is not matching.');
								
								$("#id_additional_before_endline2_tested").css('border-color', 'red'); 
								$("#id_additional_before_endline2_reading_beg").css('border-color', 'red'); 
								$("#id_additional_before_endline2_reading_letter").css('border-color', 'red'); 						
								$("#id_additional_before_endline2_reading_word").css('border-color', 'red'); 
								$("#id_additional_before_endline2_reading_para").css('border-color', 'red'); 
								$("#id_additional_before_endline2_reading_story").css('border-color', 'red'); 
								delete window.mismatched 

							}

							if (mismatched == 0) {

								$("#id_additional_before_endline2_tested").attr('title', '');
								$("#id_additional_before_endline2_reading_beg").attr('title', '');
								$("#id_additional_before_endline2_reading_letter").attr('title', '');
								$("#id_additional_before_endline2_reading_word").attr('title', '');
								$("#id_additional_before_endline2_reading_para").attr('title', '');
								$("#id_additional_before_endline2_reading_story").attr('title', '');
								
								$("#id_additional_before_endline2_tested").css('border-color', ''); 
								$("#id_additional_before_endline2_reading_beg").css('border-color', ''); 
								$("#id_additional_before_endline2_reading_letter").css('border-color', ''); 						
								$("#id_additional_before_endline2_reading_word").css('border-color', ''); 
								$("#id_additional_before_endline2_reading_para").css('border-color', ''); 
								$("#id_additional_before_endline2_reading_story").css('border-color', '');
							
							delete window.mismatched 
							}

						//Table 4 - tested children (Math) should be equal to no of tested children.
							var table4_tested  = +$("#id_additional_before_endline2_tested").val();
							
							var table4_math_b = +$("#id_additional_before_endline2_number_beg").val();
							var table4_math_0 = +$("#id_additional_before_endline2_number_09").val();
							var table4_math_10 = +$("#id_additional_before_endline2_number_1099").val();
							var table4_math_100 = +$("#id_additional_before_endline2_number_100999").val();
							
							var table4_math_tot = table4_math_b + table4_math_0 + table4_math_10 + table4_math_100 ;
							var mismatched = table4_tested - table4_math_tot;
																					
							if (mismatched != 0) {
								$("#id_additional_before_endline2_tested").attr('title', 'Number of children entered for calss and gender is not matching.');
								$("#id_additional_before_endline2_number_beg").attr('title', 'Number of children entered for calss and gender is not matching.');
								$("#id_additional_before_endline2_number_09").attr('title', 'Number of children entered for calss and gender is not matching.');
								$("#id_additional_before_endline2_number_1099").attr('title', 'Number of children entered for calss and gender is not matching.');
								$("#id_additional_before_endline2_number_100999").attr('title', 'Number of children entered for calss and gender is not matching.');
																
								$("#id_additional_before_endline2_tested").css('border-color', 'red'); 
								$("#id_additional_before_endline2_number_beg").css('border-color', 'red'); 
								$("#id_additional_before_endline2_number_09").css('border-color', 'red'); 						
								$("#id_additional_before_endline2_number_1099").css('border-color', 'red'); 
								$("#id_additional_before_endline2_number_100999").css('border-color', 'red'); 								 
							}

							if (mismatched == 0) {
								$("#id_additional_before_endline2_tested").attr('title', '');
								$("#id_additional_before_endline2_number_beg").attr('title', '');
								$("#id_additional_before_endline2_number_09").attr('title', '');
								$("#id_additional_before_endline2_number_1099").attr('title', '');
								$("#id_additional_before_endline2_number_100999").attr('title', '');
																
								$("#id_additional_before_endline2_tested").css('border-color', ''); 
								$("#id_additional_before_endline2_number_beg").css('border-color', ''); 
								$("#id_additional_before_endline2_number_09").css('border-color', ''); 						
								$("#id_additional_before_endline2_number_1099").css('border-color', ''); 
								$("#id_additional_before_endline2_number_100999").css('border-color', ''); 
							}		  					
						//Table 5 - tested children (Lang) should be equal to no of tested children.	
							var table5_tested  = +$("#id_lc2_endline_totaltested").val();
							
							var table5_lan_b = +$("#id_lc2_endline_reading_beg").val();
							var table5_lan_l = +$("#id_lc2_endline_reading_letter").val();
							var table5_lan_w = +$("#id_lc2_endline_reading_word").val();
							var table5_lan_p = +$("#id_lc2_endline_reading_para").val();
							var table5_lan_s = +$("#id_lc2_endline_reading_story").val();

							var table5_lan_tot = table5_lan_b + table5_lan_l + table5_lan_w + table5_lan_p + table5_lan_s;

							var mismatched = table5_tested - table5_lan_tot;
														

							if (mismatched != 0) {
								$("#id_lc2_endline_totaltested").attr('title', 'Number of children entered for calss and gender is not matching.');
								$("#id_lc2_endline_reading_beg").attr('title', 'Number of children entered for calss and gender is not matching.');
								$("#id_lc2_endline_reading_letter").attr('title', 'Number of children entered for calss and gender is not matching.');
								$("#id_lc2_endline_reading_word").attr('title', 'Number of children entered for calss and gender is not matching.');
								$("#id_lc2_endline_reading_para").attr('title', 'Number of children entered for calss and gender is not matching.');
								$("#id_lc2_endline_reading_story").attr('title', 'Number of children entered for calss and gender is not matching.');
								
								$("#id_lc2_endline_totaltested").css('border-color', 'red'); 
								$("#id_lc2_endline_reading_beg").css('border-color', 'red'); 
								$("#id_lc2_endline_reading_letter").css('border-color', 'red'); 						
								$("#id_lc2_endline_reading_word").css('border-color', 'red'); 
								$("#id_lc2_endline_reading_para").css('border-color', 'red'); 
								$("#id_lc2_endline_reading_story").css('border-color', 'red'); 
							}

							if (mismatched == 0) {

								$("#id_lc2_endline_totaltested").attr('title', '');
								$("#id_lc2_endline_reading_beg").attr('title', '');
								$("#id_lc2_endline_reading_letter").attr('title', '');
								$("#id_lc2_endline_reading_word").attr('title', '');
								$("#id_lc2_endline_reading_para").attr('title', '');
								$("#id_lc2_endline_reading_story").attr('title', '');
								
								$("#id_lc2_endline_totaltested").css('border-color', ''); 
								$("#id_lc2_endline_reading_beg").css('border-color', ''); 
								$("#id_lc2_endline_reading_letter").css('border-color', ''); 						
								$("#id_lc2_endline_reading_word").css('border-color', ''); 
								$("#id_lc2_endline_reading_para").css('border-color', ''); 
								$("#id_lc2_endline_reading_story").css('border-color', '');
							
							delete window.mismatched 
							}

						//Table 5 - tested children (Math) should be equal to no of tested children.							
							var table5_math_b = +$("#id_lc2_endline_number_beg").val();
							var table5_math_0 = +$("#id_lc2_endline_number_09").val();
							var table5_math_10 = +$("#id_lc2_endline_number_1099").val();
							var table5_math_100 = +$("#id_lc2_endline_number_100999").val();
							
							var table5_math_tot = table5_math_b + table5_math_0 + table5_math_10 + table5_math_100 ;
							var mismatched = table5_tested - table5_math_tot;
																					
							if (mismatched != 0) {
								$("#id_lc2_endline_totaltested").attr('title', 'Number of children entered for calss and gender is not matching.');
								$("#id_lc2_endline_number_beg").attr('title', 'Number of children entered for calss and gender is not matching.');								
								$("#id_lc2_endline_number_09").attr('title', 'Number of children entered for calss and gender is not matching.');
								$("#id_lc2_endline_number_1099").attr('title', 'Number of children entered for calss and gender is not matching.');
								$("#id_lc2_endline_number_100999").attr('title', 'Number of children entered for calss and gender is not matching.');
																
								$("#id_lc2_endline_totaltested").css('border-color', 'red'); 
								$("#id_lc2_endline_number_beg").css('border-color', 'red'); 
								$("#id_lc2_endline_number_09").css('border-color', 'red'); 						
								$("#id_lc2_endline_number_1099").css('border-color', 'red'); 
								$("#id_lc2_endline_number_100999").css('border-color', 'red'); 								 
							}

							if (mismatched == 0) {
								$("#id_lc2_endline_totaltested").attr('title', '');
								$("#id_lc2_endline_number_beg").attr('title', '');
								$("#id_lc2_endline_number_09").attr('title', '');
								$("#id_lc2_endline_number_1099").attr('title', '');
								$("#id_lc2_endline_number_100999").attr('title', '');
																
								$("#id_lc2_endline_totaltested").css('border-color', ''); 
								$("#id_lc2_endline_number_beg").css('border-color', ''); 
								$("#id_lc2_endline_number_09").css('border-color', ''); 						
								$("#id_lc2_endline_number_1099").css('border-color', ''); 
								$("#id_lc2_endline_number_100999").css('border-color', ''); 
							}		  					

						//Table 5 - tested children (Operations) should be equal to no of tested children.							

							var table5_add_c = +$("#id_lc2_endline_add_can").val();
							var table5_add_cn = +$("#id_lc2_endline_add_cant").val();
							var table5_add_total = table5_add_c + table5_add_cn;

							var mismatched = table5_tested - table5_add_total;

							if (mismatched != 0) {
								$("#id_lc2_endline_totaltested").attr('title', 'No of children tested and children are in operations are not equal');
								$("#id_lc2_endline_add_can").attr('title', 'No of children tested and children are in operations are not equal');
								$("#id_lc2_endline_add_cant").attr('title', 'No of children tested and children are in operations are not equal');								
								
								$("#id_lc2_endline_totaltested").css('border-color', 'red');								
								$("#id_lc2_endline_add_can").css('border-color', 'red'); 
								$("#id_lc2_endline_add_cant").css('border-color', 'red'); 
							}

							if (mismatched == 0) {
								$("#id_lc2_endline_totaltested").attr('title', '');
								$("#id_lc2_endline_add_can").attr('title', '');
								$("#id_lc2_endline_add_cant").attr('title', '');

								$("#id_lc2_endline_totaltested").css('border-color', 'red');																
								$("#id_lc2_endline_add_can").css('border-color', ''); 
								$("#id_lc2_endline_add_cant").css('border-color', ''); 
							}		  					


							var table5_sub_c = +$("#id_lc2_endline_sub_can").val();
							var table5_sub_cn = +$("#id_lc2_endline_sub_cant").val();
							var table5_sub_total = table5_sub_c + table5_sub_cn;

							var mismatched = table5_tested - table5_sub_total;

							if (mismatched != 0) {
								$("#id_lc2_endline_totaltested").attr('title', 'No of children tested and children are in operations are not equal');
								$("#id_lc2_endline_sub_can").attr('title', 'No of children tested and children are in operations are not equal');
								$("#id_lc2_endline_sub_cant").attr('title', 'No of children tested and children are in operations are not equal');								
								
								$("#id_lc2_endline_totaltested").css('border-color', 'red');								
								$("#id_lc2_endline_sub_can").css('border-color', 'red'); 
								$("#id_lc2_endline_sub_cant").css('border-color', 'red'); 
							}

							if (mismatched == 0) {
								$("#id_lc2_endline_totaltested").attr('title', '');
								$("#id_lc2_endline_sub_can").attr('title', '');
								$("#id_lc2_endline_sub_cant").attr('title', '');

								$("#id_lc2_endline_totaltested").css('border-color', 'red');																
								$("#id_lc2_endline_sub_can").css('border-color', ''); 
								$("#id_lc2_endline_sub_cant").css('border-color', ''); 
							}	

							var table5_mul_c = +$("#id_lc2_endline_mul_can").val();
							var table5_mul_cn = +$("#id_lc2_endline_mul_cant").val();
							var table5_mul_total = table5_mul_c + table5_mul_cn;

							var mismatched = table5_tested - table5_mul_total;

							if (mismatched != 0) {
								$("#id_lc2_endline_totaltested").attr('title', 'No of children tested and children are in operations are not equal');
								$("#id_lc2_endline_mul_can").attr('title', 'No of children tested and children are in operations are not equal');
								$("#id_lc2_endline_mul_cant").attr('title', 'No of children tested and children are in operations are not equal');								
								
								$("#id_lc2_endline_totaltested").css('border-color', 'red');								
								$("#id_lc2_endline_mul_can").css('border-color', 'red'); 
								$("#id_lc2_endline_mul_cant").css('border-color', 'red'); 
							}

							if (mismatched == 0) {
								$("#id_lc2_endline_totaltested").attr('title', '');
								$("#id_lc2_endline_mul_can").attr('title', '');
								$("#id_lc2_endline_mul_cant").attr('title', '');

								$("#id_lc2_endline_totaltested").css('border-color', 'red');																
								$("#id_lc2_endline_mul_can").css('border-color', ''); 
								$("#id_lc2_endline_mul_cant").css('border-color', ''); 
							}	

							var table5_div_c = +$("#id_lc2_endline_div_can").val();
							var table5_div_cn = +$("#id_lc2_endline_div_cant").val();
							var table5_div_total = table5_div_c + table5_div_cn;

							var mismatched = table5_tested - table5_div_total;

							if (mismatched != 0) {
								$("#id_lc2_endline_totaltested").attr('title', 'No of children tested and children are in operations are not equal');
								$("#id_lc2_endline_div_can").attr('title', 'No of children tested and children are in operations are not equal');
								$("#id_lc2_endline_div_cant").attr('title', 'No of children tested and children are in operations are not equal');								
								
								$("#id_lc2_endline_totaltested").css('border-color', 'red');								
								$("#id_lc2_endline_div_can").css('border-color', 'red'); 
								$("#id_lc2_endline_div_cant").css('border-color', 'red'); 
							}

							if (mismatched == 0) {
								$("#id_lc2_endline_totaltested").attr('title', '');
								$("#id_lc2_endline_div_can").attr('title', '');
								$("#id_lc2_endline_div_cant").attr('title', '');

								$("#id_lc2_endline_totaltested").css('border-color', 'red');																
								$("#id_lc2_endline_div_can").css('border-color', ''); 
								$("#id_lc2_endline_div_cant").css('border-color', ''); 
							}						
					};	
				...
				if (submitting_camp == 2 ){					
					...
					//Validation 4 - Number of teaching days Range 0 to 10.				
				  		if ($("#id_teachingdays_camp3").val() >10 ) {			
							$("#id_teachingdays_camp3").attr('title', 'Teaching Days should not be more than 10 digits.');		  
	  						$("#id_teachingdays_camp3").css('border-color', 'red'); 		
	  					}; 			
									
					//Validation 6 - Number of Visits Range - 0 to 10 Table 2.			
				  		if ($("#id_noofvisits_camp3").val() >10 ) {		
							$("#id_noofvisits_camp3").attr('title', 'DISE code should not be more or less than 10 digits.');	
	  						$("#id_noofvisits_camp3").css('border-color', 'red'); 	
	  					};		
					//Validation 7 - Volunteer Attendance in Table 3.			
								
				  		if ($("#id_volunteer1_attendance_camp3").val() >10 ) {		
							$("#id_volunteer1_attendance_camp3").attr('title', 'Volunteer Attendance should not be more No of Camp Days');	
	  						$("#id_volunteer1_attendance_camp3").css('border-color', 'red'); 	
	  					};		
				  		if ($("#id_volunteer2_attendance_camp3").val() >10 ) {		
							$("#id_volunteer2_attendance_camp3").attr('title', 'Volunteer Attendance should not be more No of Camp Days');	
	  						$("#id_volunteer2_attendance_camp3").css('border-color', 'red'); 	
	  					};		
				  		if ($("#id_volunteer3_attendance_camp3").val() >10 ) {		
							$("#id_volunteer3_attendance_camp3").attr('title', 'Volunteer Attendance should not be more No of Camp Days');	
	  						$("#id_volunteer3_attendance_camp3").css('border-color', 'red'); 	
	  					};		
				  		if ($("#id_volunteer4_attendance_camp3").val() >10 ) {		
							$("#id_volunteer4_attendance_camp3").attr('title', 'Volunteer Attendance should not be more No of Camp Days');	
	  						$("#id_volunteer4_attendance_camp3").css('border-color', 'red'); 	
	  					};		
				  		if ($("#id_volunteer5_attendance_camp3").val() >10 ) {		
							$("#id_volunteer5_attendance_camp3").attr('title', 'Volunteer Attendance should not be more No of Camp Days');	
	  						$("#id_volunteer5_attendance_camp3").css('border-color', 'red'); 	
	  					};		
				  		if ($("#id_volunteer6_attendance_camp3").val() >10 ) {		
							$("#id_volunteer6_attendance_camp3").attr('title', 'Volunteer Attendance should not be more No of Camp Days');	
	  						$("#id_volunteer6_attendance_camp3").css('border-color', 'red'); 	
	  					};		
				  		if ($("#id_volunteer7_attendance_camp3").val() >10 ) {		
							$("#id_volunteer7_attendance_camp3").attr('title', 'Volunteer Attendance should not be more No of Camp Days');	
	  						$("#id_volunteer7_attendance_camp3").css('border-color', 'red'); 	
	  					};		
				  		if ($("#id_volunteer8_attendance_camp3").val() >10 ) {		
							$("#id_volunteer8_attendance_camp3").attr('title', 'Volunteer Attendance should not be more No of Camp Days');	
	  						$("#id_volunteer8_attendance_camp3").css('border-color', 'red'); 	
	  					};		
				  		if ($("#id_volunteer9_attendance_camp3").val() >10 ) {		
							$("#id_volunteer9_attendance_camp3").attr('title', 'Volunteer Attendance should not be more No of Camp Days');	
	  						$("#id_volunteer9_attendance_camp3").css('border-color', 'red'); 	
	  					};		
				  		if ($("#id_volunteer10_attendance_camp3").val() >10 ) {		
							$("#id_volunteer10_attendance_camp3").attr('title', 'Volunteer Attendance should not be more No of Camp Days');	
	  						$("#id_volunteer10_attendance_camp3").css('border-color', 'red'); 	
	  					};		  
					//Table 4 - tested children (Lang) should be equal to no of tested children.			
						var table4_tested  = +$("#id_additional_before_endline3_tested").val();		
								
						var table4_lan_b = +$("#id_additional_before_endline3_reading_beg").val();		
						var table4_lan_l = +$("#id_additional_before_endline3_reading_letter").val();		
						var table4_lan_w = +$("#id_additional_before_endline3_reading_word").val();		
						var table4_lan_p = +$("#id_additional_before_endline3_reading_para").val();		
						var table4_lan_s = +$("#id_additional_before_endline3_reading_story").val();		
						...
						if (mismatched != 0) {		
							$("#id_additional_before_endline3_tested").attr('title', 'Number of children entered for calss and gender is not matching.');	
							$("#id_additional_before_endline3_reading_beg").attr('title', 'Number of children entered for calss and gender is not matching.');	
							$("#id_additional_before_endline3_reading_letter").attr('title', 'Number of children entered for calss and gender is not matching.');	
							$("#id_additional_before_endline3_reading_word").attr('title', 'Number of children entered for calss and gender is not matching.');	
							$("#id_additional_before_endline3_reading_para").attr('title', 'Number of children entered for calss and gender is not matching.');	
							$("#id_additional_before_endline3_reading_story").attr('title', 'Number of children entered for calss and gender is not matching.');	
								
							$("#id_additional_before_endline3_tested").css('border-color', 'red'); 	
							$("#id_additional_before_endline3_reading_beg").css('border-color', 'red'); 	
							$("#id_additional_before_endline3_reading_letter").css('border-color', 'red'); 	
							$("#id_additional_before_endline3_reading_word").css('border-color', 'red'); 	
							$("#id_additional_before_endline3_reading_para").css('border-color', 'red'); 	
							$("#id_additional_before_endline3_reading_story").css('border-color', 'red'); 	
							delete window.mismatched 	
						...
						if (mismatched == 0) {		
							...
							$("#id_additional_before_endline3_tested").attr('title', '');	
							$("#id_additional_before_endline3_reading_beg").attr('title', '');	
							$("#id_additional_before_endline3_reading_letter").attr('title', '');	
							$("#id_additional_before_endline3_reading_word").attr('title', '');	
							$("#id_additional_before_endline3_reading_para").attr('title', '');	
							$("#id_additional_before_endline3_reading_story").attr('title', '');	
								
							$("#id_additional_before_endline3_tested").css('border-color', ''); 	
							$("#id_additional_before_endline3_reading_beg").css('border-color', ''); 	
							$("#id_additional_before_endline3_reading_letter").css('border-color', ''); 	
							$("#id_additional_before_endline3_reading_word").css('border-color', ''); 	
							$("#id_additional_before_endline3_reading_para").css('border-color', ''); 	
							$("#id_additional_before_endline3_reading_story").css('border-color', '');	
					...
					//Table 4 - tested children (Math) should be equal to no of tested children.			
						...
						var table4_math_b = +$("#id_additional_before_endline3_number_beg").val();		
						var table4_math_0 = +$("#id_additional_before_endline3_number_09").val();		
						var table4_math_10 = +$("#id_additional_before_endline3_number_1099").val();		
						var table4_math_100 = +$("#id_additional_before_endline3_number_100999").val();		
						...
						if (mismatched != 0) {		
							$("#id_additional_before_endline3_tested").attr('title', 'Number of children entered for calss and gender is not matching.');	
							$("#id_additional_before_endline3_number_beg").attr('title', 'Number of children entered for calss and gender is not matching.');	
							$("#id_additional_before_endline3_number_09").attr('title', 'Number of children entered for calss and gender is not matching.');	
							$("#id_additional_before_endline3_number_1099").attr('title', 'Number of children entered for calss and gender is not matching.');	
							$("#id_additional_before_endline3_number_100999").attr('title', 'Number of children entered for calss and gender is not matching.');	
								
							$("#id_additional_before_endline3_tested").css('border-color', 'red'); 	
							$("#id_additional_before_endline3_number_beg").css('border-color', 'red'); 	
							$("#id_additional_before_endline3_number_09").css('border-color', 'red'); 	
							$("#id_additional_before_endline3_number_1099").css('border-color', 'red'); 	
							$("#id_additional_before_endline3_number_100999").css('border-color', 'red'); 	
						}		
								
						if (mismatched == 0) {		
							$("#id_additional_before_endline3_tested").attr('title', '');	
							$("#id_additional_before_endline3_number_beg").attr('title', '');	
							$("#id_additional_before_endline3_number_09").attr('title', '');	
							$("#id_additional_before_endline3_number_1099").attr('title', '');	
							$("#id_additional_before_endline3_number_100999").attr('title', '');	
								
							$("#id_additional_before_endline3_tested").css('border-color', ''); 	
							$("#id_additional_before_endline3_number_beg").css('border-color', ''); 	
							$("#id_additional_before_endline3_number_09").css('border-color', ''); 	
							$("#id_additional_before_endline3_number_1099").css('border-color', ''); 	
							$("#id_additional_before_endline3_number_100999").css('border-color', ''); 	
						}		  
					//Table 5 - tested children (Lang) should be equal to no of tested children.			
						var table5_tested  = +$("#id_lc3_endline_totaltested").val();		
								
						var table5_lan_b = +$("#id_lc3_endline_reading_beg").val();		
						var table5_lan_l = +$("#id_lc3_endline_reading_letter").val();		
						var table5_lan_w = +$("#id_lc3_endline_reading_word").val();		
						var table5_lan_p = +$("#id_lc3_endline_reading_para").val();		
						var table5_lan_s = +$("#id_lc3_endline_reading_story").val();		
						...
						if (mismatched != 0) {		
							$("#id_lc3_endline_totaltested").attr('title', 'Number of children entered for calss and gender is not matching.');	
							$("#id_lc3_endline_reading_beg").attr('title', 'Number of children entered for calss and gender is not matching.');	
							$("#id_lc3_endline_reading_letter").attr('title', 'Number of children entered for calss and gender is not matching.');	
							$("#id_lc3_endline_reading_word").attr('title', 'Number of children entered for calss and gender is not matching.');	
							$("#id_lc3_endline_reading_para").attr('title', 'Number of children entered for calss and gender is not matching.');	
							$("#id_lc3_endline_reading_story").attr('title', 'Number of children entered for calss and gender is not matching.');	
								
							$("#id_lc3_endline_totaltested").css('border-color', 'red'); 	
							$("#id_lc3_endline_reading_beg").css('border-color', 'red'); 	
							$("#id_lc3_endline_reading_letter").css('border-color', 'red'); 	
							$("#id_lc3_endline_reading_word").css('border-color', 'red'); 	
							$("#id_lc3_endline_reading_para").css('border-color', 'red'); 	
							$("#id_lc3_endline_reading_story").css('border-color', 'red'); 	
						}		
								
						if (mismatched == 0) {		
								
							$("#id_lc3_endline_totaltested").attr('title', '');	
							$("#id_lc3_endline_reading_beg").attr('title', '');	
							$("#id_lc3_endline_reading_letter").attr('title', '');	
							$("#id_lc3_endline_reading_word").attr('title', '');	
							$("#id_lc3_endline_reading_para").attr('title', '');	
							$("#id_lc3_endline_reading_story").attr('title', '');	
								
							$("#id_lc3_endline_totaltested").css('border-color', ''); 	
							$("#id_lc3_endline_reading_beg").css('border-color', ''); 	
							$("#id_lc3_endline_reading_letter").css('border-color', ''); 	
							$("#id_lc3_endline_reading_word").css('border-color', ''); 	
							$("#id_lc3_endline_reading_para").css('border-color', ''); 	
							$("#id_lc3_endline_reading_story").css('border-color', '');	
								
						delete window.mismatched 		
						}		
								
					//Table 5 - tested children (Math) should be equal to no of tested children.			
						var table5_math_b = +$("#id_lc3_endline_number_beg").val();		
						var table5_math_0 = +$("#id_lc3_endline_number_09").val();		
						var table5_math_10 = +$("#id_lc3_endline_number_1099").val();		
						var table5_math_100 = +$("#id_lc3_endline_number_100999").val();		
						...
						if (mismatched != 0) {		
							$("#id_lc3_endline_totaltested").attr('title', 'Number of children entered for calss and gender is not matching.');	
							$("#id_lc3_endline_number_beg").attr('title', 'Number of children entered for calss and gender is not matching.');	
							$("#id_lc3_endline_number_09").attr('title', 'Number of children entered for calss and gender is not matching.');	
							$("#id_lc3_endline_number_1099").attr('title', 'Number of children entered for calss and gender is not matching.');	
							$("#id_lc3_endline_number_100999").attr('title', 'Number of children entered for calss and gender is not matching.');	
								
							$("#id_lc3_endline_totaltested").css('border-color', 'red'); 	
							$("#id_lc3_endline_number_beg").css('border-color', 'red'); 	
							$("#id_lc3_endline_number_09").css('border-color', 'red'); 	
							$("#id_lc3_endline_number_1099").css('border-color', 'red'); 	
							$("#id_lc3_endline_number_100999").css('border-color', 'red'); 	
						}		
								
						if (mismatched == 0) {		
							$("#id_lc3_endline_totaltested").attr('title', '');	
							$("#id_lc3_endline_number_beg").attr('title', '');	
							$("#id_lc3_endline_number_09").attr('title', '');	
							$("#id_lc3_endline_number_1099").attr('title', '');	
							$("#id_lc3_endline_number_100999").attr('title', '');	
								
							$("#id_lc3_endline_totaltested").css('border-color', ''); 	
							$("#id_lc3_endline_number_beg").css('border-color', ''); 	
							$("#id_lc3_endline_number_09").css('border-color', ''); 	
							$("#id_lc3_endline_number_1099").css('border-color', ''); 	
							$("#id_lc3_endline_number_100999").css('border-color', ''); 	
						}		  
								
					//Table 5 - tested children (Operations) should be equal to no of tested children.			
								
						var table5_add_c = +$("#id_lc3_endline_add_can").val();		
						var table5_add_cn = +$("#id_lc3_endline_add_cant").val();		
						var table5_add_total = table5_add_c + table5_add_cn;		
								
						var mismatched = table5_tested - table5_add_total;		
								
						if (mismatched != 0) {		
							$("#id_lc3_endline_totaltested").attr('title', 'No of children tested and children are in operations are not equal');	
							$("#id_lc3_endline_add_can").attr('title', 'No of children tested and children are in operations are not equal');	
							$("#id_lc3_endline_add_cant").attr('title', 'No of children tested and children are in operations are not equal');	
								
							$("#id_lc3_endline_totaltested").css('border-color', 'red');	
							$("#id_lc3_endline_add_can").css('border-color', 'red'); 	
							$("#id_lc3_endline_add_cant").css('border-color', 'red'); 	
						}		
								
						if (mismatched == 0) {		
							$("#id_lc3_endline_totaltested").attr('title', '');	
							$("#id_lc3_endline_add_can").attr('title', '');	
							$("#id_lc3_endline_add_cant").attr('title', '');	
								
							$("#id_lc3_endline_totaltested").css('border-color', 'red');	
							$("#id_lc3_endline_add_can").css('border-color', ''); 	
							$("#id_lc3_endline_add_cant").css('border-color', ''); 	
						}		  
								
								
						var table5_sub_c = +$("#id_lc3_endline_sub_can").val();		
						var table5_sub_cn = +$("#id_lc3_endline_sub_cant").val();		
						var table5_sub_total = table5_sub_c + table5_sub_cn;		
						...
						if (mismatched != 0) {		
							$("#id_lc3_endline_totaltested").attr('title', 'No of children tested and children are in operations are not equal');	
							$("#id_lc3_endline_sub_can").attr('title', 'No of children tested and children are in operations are not equal');	
							$("#id_lc3_endline_sub_cant").attr('title', 'No of children tested and children are in operations are not equal');	
								
							$("#id_lc3_endline_totaltested").css('border-color', 'red');	
							$("#id_lc3_endline_sub_can").css('border-color', 'red'); 	
							$("#id_lc3_endline_sub_cant").css('border-color', 'red'); 	
						}		
								
						if (mismatched == 0) {		
							$("#id_lc3_endline_totaltested").attr('title', '');	
							$("#id_lc3_endline_sub_can").attr('title', '');	
							$("#id_lc3_endline_sub_cant").attr('title', '');	
								
							$("#id_lc3_endline_totaltested").css('border-color', 'red');	
							$("#id_lc3_endline_sub_can").css('border-color', ''); 	
							$("#id_lc3_endline_sub_cant").css('border-color', ''); 	
						}		
								
						var table5_mul_c = +$("#id_lc3_endline_mul_can").val();		
						var table5_mul_cn = +$("#id_lc3_endline_mul_cant").val();		
						var table5_mul_total = table5_mul_c + table5_mul_cn;		
						...
						if (mismatched != 0) {		
							$("#id_lc3_endline_totaltested").attr('title', 'No of children tested and children are in operations are not equal');	
							$("#id_lc3_endline_mul_can").attr('title', 'No of children tested and children are in operations are not equal');	
							$("#id_lc3_endline_mul_cant").attr('title', 'No of children tested and children are in operations are not equal');	
								
							$("#id_lc3_endline_totaltested").css('border-color', 'red');	
							$("#id_lc3_endline_mul_can").css('border-color', 'red'); 	
							$("#id_lc3_endline_mul_cant").css('border-color', 'red'); 	
						}		
								
						if (mismatched == 0) {		
							$("#id_lc3_endline_totaltested").attr('title', '');	
							$("#id_lc3_endline_mul_can").attr('title', '');	
							$("#id_lc3_endline_mul_cant").attr('title', '');	
								
							$("#id_lc3_endline_totaltested").css('border-color', 'red');	
							$("#id_lc3_endline_mul_can").css('border-color', ''); 	
							$("#id_lc3_endline_mul_cant").css('border-color', ''); 	
						}		
								
						var table5_div_c = +$("#id_lc3_endline_div_can").val();		
						var table5_div_cn = +$("#id_lc3_endline_div_cant").val();		
						var table5_div_total = table5_div_c + table5_div_cn;		
						...
						if (mismatched != 0) {		
							$("#id_lc3_endline_totaltested").attr('title', 'No of children tested and children are in operations are not equal');	
							$("#id_lc3_endline_div_can").attr('title', 'No of children tested and children are in operations are not equal');	
							$("#id_lc3_endline_div_cant").attr('title', 'No of children tested and children are in operations are not equal');	
								
							$("#id_lc3_endline_totaltested").css('border-color', 'red');	
							$("#id_lc3_endline_div_can").css('border-color', 'red'); 	
							$("#id_lc3_endline_div_cant").css('border-color', 'red'); 	
						}		
								
						if (mismatched == 0) {		
							$("#id_lc3_endline_totaltested").attr('title', '');	
							$("#id_lc3_endline_div_can").attr('title', '');	
							$("#id_lc3_endline_div_cant").attr('title', '');	
								
							$("#id_lc3_endline_totaltested").css('border-color', 'red');	
							$("#id_lc3_endline_div_can").css('border-color', ''); 	
							$("#id_lc3_endline_div_cant").css('border-color', ''); 	
						}		
				};

				// Validation for Camp 4 Entry.
				if (submitting_camp == 3 ){					
					var err = 1										
					...
					//Total common children should not be more than enroled children from table 4
						debugger;
						var common_ch = +$("#id_commonchildren").val();

						var table4_enroll_std3  = +$("#id_std3_enroll").val();				
						var table4_enroll_std4  = +$("#id_std4_enrolled").val();				
						var table4_enroll_std5  = +$("#id_std5_enrolled").val();				
											
						var table4_enroll = table4_enroll_std3 + table4_enroll_std4 + table4_enroll_std5;				
										
						var mismatched = table4_enroll - common_ch;				
										
										
						if (mismatched != 0 ) {				
							$("#id_commonchildren").attr('title', 'Common children can not be more than enrolled children');			
										
							$("#id_commonchildren").css('border-color', 'red'); 			
							delete window.mismatched 			
											
						}				
										
						if ((mismatched == 0) && ($("#id_commonchildren").val().trim().length != 0)) {														
							$("#id_commonchildren").attr('title', '');													
							$("#id_commonchildren").css('border-color', ''); 			
							delete window.mismatched					
						}
					...
					//Validation 4 - Number of teaching days Range 0 to 10.						
				  		if ($("#id_teachingdays_camp4").val() >10 ) {					
							$("#id_teachingdays_camp4").attr('title', 'Teaching Days should not be more than 10 digits.');		  		
	  						$("#id_teachingdays_camp4").css('border-color', 'red'); 				
	  					}; 					
											
					//Validation 6 - Number of Visits Range - 0 to 10 Table 2.					
				  		if ($("#id_noofvisits_camp4").val() >10 ) {				
							$("#id_noofvisits_camp4").attr('title', 'DISE code should not be more or less than 10 digits.');		  	
	  						$("#id_noofvisits_camp4").css('border-color', 'red'); 			
	  					};				
					//Validation 7 - Volunteer Attendance in Table 3.					
										
				  		if ($("#id_volunteer1_attendance_camp4").val() >10 ) {				
							$("#id_volunteer1_attendance_camp4").attr('title', 'Volunteer Attendance should not be more No of Camp Days');		  	
	  						$("#id_volunteer1_attendance_camp4").css('border-color', 'red'); 			
	  					};				
				  		if ($("#id_volunteer2_attendance_camp4").val() >10 ) {				
							$("#id_volunteer2_attendance_camp4").attr('title', 'Volunteer Attendance should not be more No of Camp Days');		  	
	  						$("#id_volunteer2_attendance_camp4").css('border-color', 'red'); 			
	  					};				
				  		if ($("#id_volunteer3_attendance_camp4").val() >10 ) {				
							$("#id_volunteer3_attendance_camp4").attr('title', 'Volunteer Attendance should not be more No of Camp Days');		  	
	  						$("#id_volunteer3_attendance_camp4").css('border-color', 'red'); 			
	  					};				
				  		if ($("#id_volunteer4_attendance_camp4").val() >10 ) {				
							$("#id_volunteer4_attendance_camp4").attr('title', 'Volunteer Attendance should not be more No of Camp Days');		  	
	  						$("#id_volunteer4_attendance_camp4").css('border-color', 'red'); 			
	  					};				
				  		if ($("#id_volunteer5_attendance_camp4").val() >10 ) {				
							$("#id_volunteer5_attendance_camp4").attr('title', 'Volunteer Attendance should not be more No of Camp Days');		  	
	  						$("#id_volunteer5_attendance_camp4").css('border-color', 'red'); 			
	  					};				
				  		if ($("#id_volunteer6_attendance_camp4").val() >10 ) {				
							$("#id_volunteer6_attendance_camp4").attr('title', 'Volunteer Attendance should not be more No of Camp Days');		  	
	  						$("#id_volunteer6_attendance_camp4").css('border-color', 'red'); 			
	  					};				
				  		if ($("#id_volunteer7_attendance_camp4").val() >10 ) {				
							$("#id_volunteer7_attendance_camp4").attr('title', 'Volunteer Attendance should not be more No of Camp Days');		  	
	  						$("#id_volunteer7_attendance_camp4").css('border-color', 'red'); 			
	  					};				
				  		if ($("#id_volunteer8_attendance_camp4").val() >10 ) {				
							$("#id_volunteer8_attendance_camp4").attr('title', 'Volunteer Attendance should not be more No of Camp Days');		  	
	  						$("#id_volunteer8_attendance_camp4").css('border-color', 'red'); 			
	  					};				
				  		if ($("#id_volunteer9_attendance_camp4").val() >10 ) {				
							$("#id_volunteer9_attendance_camp4").attr('title', 'Volunteer Attendance should not be more No of Camp Days');		  	
	  						$("#id_volunteer9_attendance_camp4").css('border-color', 'red'); 			
	  					};				
				  		if ($("#id_volunteer10_attendance_camp4").val() >10 ) {				
							$("#id_volunteer10_attendance_camp4").attr('title', 'Volunteer Attendance should not be more No of Camp Days');		  	
	  						$("#id_volunteer10_attendance_camp4").css('border-color', 'red'); 			
	  					};		  		
					//Table 4 - tested children (Lang) should be equal to no of tested children.					
						var table4_tested  = +$("#id_additional_before_endline4_tested").val();				
										
						var table4_lan_b = +$("#id_additional_before_endline4_reading_beg").val();				
						var table4_lan_l = +$("#id_additional_before_endline4_reading_letter").val();				
						var table4_lan_w = +$("#id_additional_before_endline4_reading_word").val();				
						var table4_lan_p = +$("#id_additional_before_endline4_reading_para").val();				
						var table4_lan_s = +$("#id_additional_before_endline4_reading_story").val();				
						...
						if (mismatched != 0) {				
							$("#id_additional_before_endline4_tested").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_additional_before_endline4_reading_beg").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_additional_before_endline4_reading_letter").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_additional_before_endline4_reading_word").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_additional_before_endline4_reading_para").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_additional_before_endline4_reading_story").attr('title', 'Number of children entered for calss and gender is not matching.');			
										
							$("#id_additional_before_endline4_tested").css('border-color', 'red'); 			
							$("#id_additional_before_endline4_reading_beg").css('border-color', 'red'); 			
							$("#id_additional_before_endline4_reading_letter").css('border-color', 'red'); 			
							$("#id_additional_before_endline4_reading_word").css('border-color', 'red'); 			
							$("#id_additional_before_endline4_reading_para").css('border-color', 'red'); 			
							$("#id_additional_before_endline4_reading_story").css('border-color', 'red'); 			
							delete window.mismatched 			
						...
						if (mismatched == 0) {				
							...
							$("#id_additional_before_endline4_tested").attr('title', '');			
							$("#id_additional_before_endline4_reading_beg").attr('title', '');			
							$("#id_additional_before_endline4_reading_letter").attr('title', '');			
							$("#id_additional_before_endline4_reading_word").attr('title', '');			
							$("#id_additional_before_endline4_reading_para").attr('title', '');			
							$("#id_additional_before_endline4_reading_story").attr('title', '');			
										
							$("#id_additional_before_endline4_tested").css('border-color', ''); 			
							$("#id_additional_before_endline4_reading_beg").css('border-color', ''); 			
							$("#id_additional_before_endline4_reading_letter").css('border-color', ''); 			
							$("#id_additional_before_endline4_reading_word").css('border-color', ''); 			
							$("#id_additional_before_endline4_reading_para").css('border-color', ''); 			
							$("#id_additional_before_endline4_reading_story").css('border-color', '');			
					...
					//Table 4 - tested children (Math) should be equal to no of tested children.					
						...
						var table4_math_b = +$("#id_additional_before_endline4_number_beg").val();				
						var table4_math_0 = +$("#id_additional_before_endline4_number_09").val();				
						var table4_math_10 = +$("#id_additional_before_endline4_number_1099").val();				
						var table4_math_100 = +$("#id_additional_before_endline4_number_100999").val();				
						...
						if (mismatched != 0) {				
							$("#id_additional_before_endline4_tested").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_additional_before_endline4_number_beg").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_additional_before_endline4_number_09").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_additional_before_endline4_number_1099").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_additional_before_endline4_number_100999").attr('title', 'Number of children entered for calss and gender is not matching.');			
										
							$("#id_additional_before_endline4_tested").css('border-color', 'red'); 			
							$("#id_additional_before_endline4_number_beg").css('border-color', 'red'); 			
							$("#id_additional_before_endline4_number_09").css('border-color', 'red'); 			
							$("#id_additional_before_endline4_number_1099").css('border-color', 'red'); 			
							$("#id_additional_before_endline4_number_100999").css('border-color', 'red'); 			
						}				
										
						if (mismatched == 0) {				
							$("#id_additional_before_endline4_tested").attr('title', '');			
							$("#id_additional_before_endline4_number_beg").attr('title', '');			
							$("#id_additional_before_endline4_number_09").attr('title', '');			
							$("#id_additional_before_endline4_number_1099").attr('title', '');			
							$("#id_additional_before_endline4_number_100999").attr('title', '');			
										
							$("#id_additional_before_endline4_tested").css('border-color', ''); 			
							$("#id_additional_before_endline4_number_beg").css('border-color', ''); 			
							$("#id_additional_before_endline4_number_09").css('border-color', ''); 			
							$("#id_additional_before_endline4_number_1099").css('border-color', ''); 			
							$("#id_additional_before_endline4_number_100999").css('border-color', ''); 			
						}		  		
					//Table 5 - tested children (Lang) should be equal to no of tested children.					
						var table5_tested  = +$("#id_lc4_endline_totaltested").val();				
										
						var table5_lan_b = +$("#id_lc4_endline_reading_beg").val();				
						var table5_lan_l = +$("#id_lc4_endline_reading_letter").val();				
						var table5_lan_w = +$("#id_lc4_endline_reading_word").val();				
						var table5_lan_p = +$("#id_lc4_endline_reading_para").val();				
						var table5_lan_s = +$("#id_lc4_endline_reading_story").val();				
						...
						if (mismatched != 0) {				
							$("#id_lc4_endline_totaltested").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_lc4_endline_reading_beg").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_lc4_endline_reading_letter").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_lc4_endline_reading_word").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_lc4_endline_reading_para").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_lc4_endline_reading_story").attr('title', 'Number of children entered for calss and gender is not matching.');			
										
							$("#id_lc4_endline_totaltested").css('border-color', 'red'); 			
							$("#id_lc4_endline_reading_beg").css('border-color', 'red'); 			
							$("#id_lc4_endline_reading_letter").css('border-color', 'red'); 			
							$("#id_lc4_endline_reading_word").css('border-color', 'red'); 			
							$("#id_lc4_endline_reading_para").css('border-color', 'red'); 			
							$("#id_lc4_endline_reading_story").css('border-color', 'red'); 			
						}				
										
						if (mismatched == 0) {				
										
							$("#id_lc4_endline_totaltested").attr('title', '');			
							$("#id_lc4_endline_reading_beg").attr('title', '');			
							$("#id_lc4_endline_reading_letter").attr('title', '');			
							$("#id_lc4_endline_reading_word").attr('title', '');			
							$("#id_lc4_endline_reading_para").attr('title', '');			
							$("#id_lc4_endline_reading_story").attr('title', '');			
										
							$("#id_lc4_endline_totaltested").css('border-color', ''); 			
							$("#id_lc4_endline_reading_beg").css('border-color', ''); 			
							$("#id_lc4_endline_reading_letter").css('border-color', ''); 			
							$("#id_lc4_endline_reading_word").css('border-color', ''); 			
							$("#id_lc4_endline_reading_para").css('border-color', ''); 			
							$("#id_lc4_endline_reading_story").css('border-color', '');			
										
						delete window.mismatched 				
						}				
										
					//Table 5 - tested children (Math) should be equal to no of tested children.					
						var table5_math_b = +$("#id_lc4_endline_number_beg").val();				
						var table5_math_0 = +$("#id_lc4_endline_number_09").val();				
						var table5_math_10 = +$("#id_lc4_endline_number_1099").val();				
						var table5_math_100 = +$("#id_lc4_endline_number_100999").val();				
						...
						if (mismatched != 0) {				
							$("#id_lc4_endline_totaltested").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_lc4_endline_number_beg").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_lc4_endline_number_09").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_lc4_endline_number_1099").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_lc4_endline_number_100999").attr('title', 'Number of children entered for calss and gender is not matching.');			
										
							$("#id_lc4_endline_totaltested").css('border-color', 'red'); 			
							$("#id_lc4_endline_number_beg").css('border-color', 'red'); 			
							$("#id_lc4_endline_number_09").css('border-color', 'red'); 			
							$("#id_lc4_endline_number_1099").css('border-color', 'red'); 			
							$("#id_lc4_endline_number_100999").css('border-color', 'red'); 			
						}				
										
						if (mismatched == 0) {				
							$("#id_lc4_endline_totaltested").attr('title', '');			
							$("#id_lc4_endline_number_beg").attr('title', '');			
							$("#id_lc4_endline_number_09").attr('title', '');			
							$("#id_lc4_endline_number_1099").attr('title', '');			
							$("#id_lc4_endline_number_100999").attr('title', '');			
										
							$("#id_lc4_endline_totaltested").css('border-color', ''); 			
							$("#id_lc4_endline_number_beg").css('border-color', ''); 			
							$("#id_lc4_endline_number_09").css('border-color', ''); 			
							$("#id_lc4_endline_number_1099").css('border-color', ''); 			
							$("#id_lc4_endline_number_100999").css('border-color', ''); 			
						}		  		
										
					//Table 5 - tested children (Operations) should be equal to no of tested children.					
										
						var table5_add_c = +$("#id_lc4_endline_add_can").val();				
						var table5_add_cn = +$("#id_lc4_endline_add_cant").val();				
						var table5_add_total = table5_add_c + table5_add_cn;				
										
						var mismatched = table5_tested - table5_add_total;				
										
						if (mismatched != 0) {				
							$("#id_lc4_endline_totaltested").attr('title', 'No of children tested and children are in operations are not equal');			
							$("#id_lc4_endline_add_can").attr('title', 'No of children tested and children are in operations are not equal');			
							$("#id_lc4_endline_add_cant").attr('title', 'No of children tested and children are in operations are not equal');			
										
							$("#id_lc4_endline_totaltested").css('border-color', 'red');			
							$("#id_lc4_endline_add_can").css('border-color', 'red'); 			
							$("#id_lc4_endline_add_cant").css('border-color', 'red'); 			
						}				
										
						if (mismatched == 0) {				
							$("#id_lc4_endline_totaltested").attr('title', '');			
							$("#id_lc4_endline_add_can").attr('title', '');			
							$("#id_lc4_endline_add_cant").attr('title', '');			
										
							$("#id_lc4_endline_totaltested").css('border-color', 'red');			
							$("#id_lc4_endline_add_can").css('border-color', ''); 			
							$("#id_lc4_endline_add_cant").css('border-color', ''); 			
						}		  		
										
										
						var table5_sub_c = +$("#id_lc4_endline_sub_can").val();				
						var table5_sub_cn = +$("#id_lc4_endline_sub_cant").val();				
						var table5_sub_total = table5_sub_c + table5_sub_cn;				
						...
						if (mismatched != 0) {				
							$("#id_lc4_endline_totaltested").attr('title', 'No of children tested and children are in operations are not equal');			
							$("#id_lc4_endline_sub_can").attr('title', 'No of children tested and children are in operations are not equal');			
							$("#id_lc4_endline_sub_cant").attr('title', 'No of children tested and children are in operations are not equal');			
										
							$("#id_lc4_endline_totaltested").css('border-color', 'red');			
							$("#id_lc4_endline_sub_can").css('border-color', 'red'); 			
							$("#id_lc4_endline_sub_cant").css('border-color', 'red'); 			
						}				
										
						if (mismatched == 0) {				
							$("#id_lc4_endline_totaltested").attr('title', '');			
							$("#id_lc4_endline_sub_can").attr('title', '');			
							$("#id_lc4_endline_sub_cant").attr('title', '');			
										
							$("#id_lc4_endline_totaltested").css('border-color', 'red');			
							$("#id_lc4_endline_sub_can").css('border-color', ''); 			
							$("#id_lc4_endline_sub_cant").css('border-color', ''); 			
						}				
										
						var table5_mul_c = +$("#id_lc4_endline_mul_can").val();				
						var table5_mul_cn = +$("#id_lc4_endline_mul_cant").val();				
						var table5_mul_total = table5_mul_c + table5_mul_cn;				
						...
						if (mismatched != 0) {				
							$("#id_lc4_endline_totaltested").attr('title', 'No of children tested and children are in operations are not equal');			
							$("#id_lc4_endline_mul_can").attr('title', 'No of children tested and children are in operations are not equal');			
							$("#id_lc4_endline_mul_cant").attr('title', 'No of children tested and children are in operations are not equal');			
										
							$("#id_lc4_endline_totaltested").css('border-color', 'red');			
							$("#id_lc4_endline_mul_can").css('border-color', 'red'); 			
							$("#id_lc4_endline_mul_cant").css('border-color', 'red'); 			
						}				
										
						if (mismatched == 0) {				
							$("#id_lc4_endline_totaltested").attr('title', '');			
							$("#id_lc4_endline_mul_can").attr('title', '');			
							$("#id_lc4_endline_mul_cant").attr('title', '');			
										
							$("#id_lc4_endline_totaltested").css('border-color', 'red');			
							$("#id_lc4_endline_mul_can").css('border-color', ''); 			
							$("#id_lc4_endline_mul_cant").css('border-color', ''); 			
						}				
										
						var table5_div_c = +$("#id_lc4_endline_div_can").val();				
						var table5_div_cn = +$("#id_lc4_endline_div_cant").val();				
						var table5_div_total = table5_div_c + table5_div_cn;				
						...
						if (mismatched != 0) {				
							$("#id_lc4_endline_totaltested").attr('title', 'No of children tested and children are in operations are not equal');			
							$("#id_lc4_endline_div_can").attr('title', 'No of children tested and children are in operations are not equal');			
							$("#id_lc4_endline_div_cant").attr('title', 'No of children tested and children are in operations are not equal');			
										
							$("#id_lc4_endline_totaltested").css('border-color', 'red');			
							$("#id_lc4_endline_div_can").css('border-color', 'red'); 			
							$("#id_lc4_endline_div_cant").css('border-color', 'red'); 			
						}				
										
						if (mismatched == 0) {				
							$("#id_lc4_endline_totaltested").attr('title', '');			
							$("#id_lc4_endline_div_can").attr('title', '');			
							$("#id_lc4_endline_div_cant").attr('title', '');			
										
							$("#id_lc4_endline_totaltested").css('border-color', 'red');			
							$("#id_lc4_endline_div_can").css('border-color', ''); 			
							$("#id_lc4_endline_div_cant").css('border-color', ''); 			
						}				
										
						var table5_tested  = +$("#id_cons_endline_totaltested").val();				
										
						var table5_lan_b = +$("#id_cons_endline_reading_beg").val();				
						var table5_lan_l = +$("#id_cons_endline_reading_letter").val();				
						var table5_lan_w = +$("#id_cons_endline_reading_word").val();				
						var table5_lan_p = +$("#id_cons_endline_reading_para").val();				
						var table5_lan_s = +$("#id_cons_endline_reading_story").val();				
						...
						if (mismatched != 0) {				
							$("#id_cons_endline_totaltested").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_cons_endline_reading_beg").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_cons_endline_reading_letter").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_cons_endline_reading_word").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_cons_endline_reading_para").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_cons_endline_reading_story").attr('title', 'Number of children entered for calss and gender is not matching.');			
										
							$("#id_cons_endline_totaltested").css('border-color', 'red'); 			
							$("#id_cons_endline_reading_beg").css('border-color', 'red'); 			
							$("#id_cons_endline_reading_letter").css('border-color', 'red'); 			
							$("#id_cons_endline_reading_word").css('border-color', 'red'); 			
							$("#id_cons_endline_reading_para").css('border-color', 'red'); 			
							$("#id_cons_endline_reading_story").css('border-color', 'red'); 			
						}				
										
						if (mismatched == 0) {				
										
							$("#id_cons_endline_totaltested").attr('title', '');			
							$("#id_cons_endline_reading_beg").attr('title', '');			
							$("#id_cons_endline_reading_letter").attr('title', '');			
							$("#id_cons_endline_reading_word").attr('title', '');			
							$("#id_cons_endline_reading_para").attr('title', '');			
							$("#id_cons_endline_reading_story").attr('title', '');			
										
							$("#id_cons_endline_totaltested").css('border-color', ''); 			
							$("#id_cons_endline_reading_beg").css('border-color', ''); 			
							$("#id_cons_endline_reading_letter").css('border-color', ''); 			
							$("#id_cons_endline_reading_word").css('border-color', ''); 			
							$("#id_cons_endline_reading_para").css('border-color', ''); 			
							$("#id_cons_endline_reading_story").css('border-color', '');			
										
						delete window.mismatched 				
						}				
										
					//Table 5 - tested children (Math) should be equal to no of tested children.					
						var table5_math_b = +$("#id_cons_endline_number_beg").val();				
						var table5_math_0 = +$("#id_cons_endline_number_09").val();				
						var table5_math_10 = +$("#id_cons_endline_number_1099").val();				
						var table5_math_100 = +$("#id_cons_endline_number_100999").val();				
						...
						if (mismatched != 0) {				
							$("#id_cons_endline_totaltested").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_cons_endline_number_beg").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_cons_endline_number_09").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_cons_endline_number_1099").attr('title', 'Number of children entered for calss and gender is not matching.');			
							$("#id_cons_endline_number_100999").attr('title', 'Number of children entered for calss and gender is not matching.');			
										
							$("#id_cons_endline_totaltested").css('border-color', 'red'); 			
							$("#id_cons_endline_number_beg").css('border-color', 'red'); 			
							$("#id_cons_endline_number_09").css('border-color', 'red'); 			
							$("#id_cons_endline_number_1099").css('border-color', 'red'); 			
							$("#id_cons_endline_number_100999").css('border-color', 'red'); 			
						}				
										
						if (mismatched == 0) {				
							$("#id_cons_endline_totaltested").attr('title', '');			
							$("#id_cons_endline_number_beg").attr('title', '');			
							$("#id_cons_endline_number_09").attr('title', '');			
							$("#id_cons_endline_number_1099").attr('title', '');			
							$("#id_cons_endline_number_100999").attr('title', '');			
										
							$("#id_cons_endline_totaltested").css('border-color', ''); 			
							$("#id_cons_endline_number_beg").css('border-color', ''); 			
							$("#id_cons_endline_number_09").css('border-color', ''); 			
							$("#id_cons_endline_number_1099").css('border-color', ''); 			
							$("#id_cons_endline_number_100999").css('border-color', ''); 			
						}		  		
										
					//Table 5 - tested children (Operations) should be equal to no of tested children.					
										
						var table5_add_c = +$("#id_cons_endline_add_can").val();				
						var table5_add_cn = +$("#id_cons_endline_add_cant").val();				
						var table5_add_total = table5_add_c + table5_add_cn;				
										
						var mismatched = table5_tested - table5_add_total;				
										
						if (mismatched != 0) {				
							$("#id_cons_endline_totaltested").attr('title', 'No of children tested and children are in operations are not equal');			
							$("#id_cons_endline_add_can").attr('title', 'No of children tested and children are in operations are not equal');			
							$("#id_cons_endline_add_cant").attr('title', 'No of children tested and children are in operations are not equal');			
										
							$("#id_cons_endline_totaltested").css('border-color', 'red');			
							$("#id_cons_endline_add_can").css('border-color', 'red'); 			
							$("#id_cons_endline_add_cant").css('border-color', 'red'); 			
						}				
										
						if (mismatched == 0) {				
							$("#id_cons_endline_totaltested").attr('title', '');			
							$("#id_cons_endline_add_can").attr('title', '');			
							$("#id_cons_endline_add_cant").attr('title', '');			
										
							$("#id_cons_endline_totaltested").css('border-color', 'red');			
							$("#id_cons_endline_add_can").css('border-color', ''); 			
							$("#id_cons_endline_add_cant").css('border-color', ''); 			
						}		  		
										
										
						var table5_sub_c = +$("#id_cons_endline_sub_can").val();				
						var table5_sub_cn = +$("#id_cons_endline_sub_cant").val();				
						var table5_sub_total = table5_sub_c + table5_sub_cn;				
						...
						if (mismatched != 0) {				
							$("#id_cons_endline_totaltested").attr('title', 'No of children tested and children are in operations are not equal');			
							$("#id_cons_endline_sub_can").attr('title', 'No of children tested and children are in operations are not equal');			
							$("#id_cons_endline_sub_cant").attr('title', 'No of children tested and children are in operations are not equal');			
										
							$("#id_cons_endline_totaltested").css('border-color', 'red');			
							$("#id_cons_endline_sub_can").css('border-color', 'red'); 			
							$("#id_cons_endline_sub_cant").css('border-color', 'red'); 			
						}				
										
						if (mismatched == 0) {				
							$("#id_cons_endline_totaltested").attr('title', '');			
							$("#id_cons_endline_sub_can").attr('title', '');			
							$("#id_cons_endline_sub_cant").attr('title', '');			
										
							$("#id_cons_endline_totaltested").css('border-color', 'red');			
							$("#id_cons_endline_sub_can").css('border-color', ''); 			
							$("#id_cons_endline_sub_cant").css('border-color', ''); 			
						}				
										
						var table5_mul_c = +$("#id_cons_endline_mul_can").val();				
						var table5_mul_cn = +$("#id_cons_endline_mul_cant").val();				
						var table5_mul_total = table5_mul_c + table5_mul_cn;				
						...
						if (mismatched != 0) {				
							$("#id_cons_endline_totaltested").attr('title', 'No of children tested and children are in operations are not equal');			
							$("#id_cons_endline_mul_can").attr('title', 'No of children tested and children are in operations are not equal');			
							$("#id_cons_endline_mul_cant").attr('title', 'No of children tested and children are in operations are not equal');			
										
							$("#id_cons_endline_totaltested").css('border-color', 'red');			
							$("#id_cons_endline_mul_can").css('border-color', 'red'); 			
							$("#id_cons_endline_mul_cant").css('border-color', 'red'); 			
						}				
										
						if (mismatched == 0) {				
							$("#id_cons_endline_totaltested").attr('title', '');			
							$("#id_cons_endline_mul_can").attr('title', '');			
							$("#id_cons_endline_mul_cant").attr('title', '');			
										
							$("#id_cons_endline_totaltested").css('border-color', 'red');			
							$("#id_cons_endline_mul_can").css('border-color', ''); 			
							$("#id_cons_endline_mul_cant").css('border-color', ''); 			
						}				
										
						var table5_div_c = +$("#id_cons_endline_div_can").val();				
						var table5_div_cn = +$("#id_cons_endline_div_cant").val();				
						var table5_div_total = table5_div_c + table5_div_cn;				
						...
						if (mismatched != 0) {				
							$("#id_cons_endline_totaltested").attr('title', 'No of children tested and children are in operations are not equal');			
							$("#id_cons_endline_div_can").attr('title', 'No of children tested and children are in operations are not equal');			
							$("#id_cons_endline_div_cant").attr('title', 'No of children tested and children are in operations are not equal');			
										
							$("#id_cons_endline_totaltested").css('border-color', 'red');			
							$("#id_cons_endline_div_can").css('border-color', 'red'); 			
							$("#id_cons_endline_div_cant").css('border-color', 'red'); 			
						}				
										
						if (mismatched == 0) {				
							$("#id_cons_endline_totaltested").attr('title', '');			
							$("#id_cons_endline_div_can").attr('title', '');			
							$("#id_cons_endline_div_cant").attr('title', '');			
										
							$("#id_cons_endline_totaltested").css('border-color', 'red');			
							$("#id_cons_endline_div_can").css('border-color', ''); 			
							$("#id_cons_endline_div_cant").css('border-color', ''); 			
						}
